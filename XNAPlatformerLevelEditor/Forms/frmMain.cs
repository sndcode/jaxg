...
namespace XNAPlatformerLevelEditor
{
    ...
    public partial class frmMain : Form
    {
        ...
        readonly List<char> AnimatedSpriteChars = new List<char> { '1', 'A', 'B', 'C', 'D' };
        ...
        { 
            ...
            {'~', "/Tiles/BlockB0.png"},
            {':', "/Tiles/BlockB1.png"},
            {'1', "/Sprites/Player/Idle.png"},
            {'#', "/Tiles/BlockA0.png"},
        };

        string pathToContentFolder;
        //string pathToContentFolder = "C:/Users/Jeff/Desktop/Nomis_LegacyIslands/Content";
        ...
        private void showRAWToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string temp = Application.StartupPath + "\\tmp_raw.txt";
            ...
            DialogResult dialogResult = MessageBox.Show("Show raw level data ? ", "", MessageBoxButtons.YesNo);
